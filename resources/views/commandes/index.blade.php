            ...
            <div class="card w-100">
                  <div class="card-body p-4">
                        <div class="row">
                              ...
                              <div class="col">
                                    <a href="{{route('commandes.create')}}" class="btn btn-info add-new"><i class="fa fa-plus"></i> Add New</a>
                              </div>
                        </div>
                                          ...
                                          <tr class="border-top">
                                                ...
                                                <td class="border-bottom-0">
                                                      <div class="d-flex align-items-center gap-2">
                                                            <a href="{{route('commandes.show', $commande->id)}}" class="badge bg-primary rounded-3 fw-semibold">
                                                                  <span>
                                                                        <i class="ti ti-eye"></i>
                                                                  </span>
                                                            </a>
                                                            <a href="{{route('commandes.edit', $commande->id)}}" class="badge bg-warning rounded-3 fw-semibold">
                                                                  <span>
